...
# windows path
#source("V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/source_functions/source_functions.R")
...
#OBS: Paths defined to the lab computer
#inputFolder <-  "V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK"
# outputFolder <- "~/walssbasslab_server/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/2.Output_EWAS-models/"
# knitr::opts_knit$set(root.dir = inputFolder)
```
...
```{r}
date <- "Aug.2024"
# - BDS vs. HC DMPs - Accounting for smoking
DMPs <- read.csv(file.path(inputFolder,"1.Base-Model/EWAS-BB-BDSvsHC_DMPs_Aug.2024.csv"), row.names = 1)

# - BDS vs. HC DMPs svaPCs - Accounting for smoking
DMPsSVA <- read.csv(file.path(inputFolder,"1.Base-Model/EWAS-BB-BDSvsHC_DMPs_svaPCs_Aug.2024.csv"), row.names = 1)
...
### Manhatam
```{r}
BDSvsHCManhattanPlot <- paste0("EWAS-BB-BDSvsHC_ManhattanPlot_",date,".png")
BDSvsHCsvaPCs_ManhattanPlot <- paste0("EWAS-BB-BDSvsHC_svaPCs_ManhattanPlot_",date,".png") 
```

### QQplot 
```{r}
BDSvsHCQQplot <- paste0("EWAS-BB-BDSvsHC_QQplot_",date,".png")
BDSvsHCQQplot_svaPCs <- paste0("EWAS-BB-BDSvsHC_QQplot_svaPCs_",date,".png")
```
### Volcano Plot
```{r}
BDSvsHC_FDR_CorrectedVolcanoPlot <- paste0("EWAS-BB-BDSvsHC_FDR-Corrected_VolcanoPlot",date,".png")
BDSvsHC_FDR_Corrected_svaPCsVolcanoPlot <- paste0("EWAS-BB-BDSvsHC_FDR-Corrected_svaPC_sVolcanoPlot",date,".png")
```
...
if(fdr_threshold %in% c(Inf, -Inf)){
  return(FALSE)
}
else{return(fdr_threshold)}
}
###############################################################################
...
g + 
  ...
  ggtitle("BDS vs. HC Manhattan Plot") +
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U")) +
  ylim(0,10)
ggsave(filename = BDSvsHCManhattanPlot ,path = file.path(outputFolder,"2.ManhattanPlots/"), device='png', dpi=300, width = 10, height = 7)
...
g + 
  ...
  geom_hline(yintercept = EWSthresh, color = "red", linetype = "dashed") +
  geom_hline(yintercept = FDRthres, color = "blue4", linetype = "longdash") +
  ggtitle("BDS vs. HC Manhattan Plot - svaPCs") +
  theme(plot.title = element_text(size = 12, face = "bold", family = "Segoi U")) +
  ylim(0,10)
ggsave(filename = BDSvsHCsvaPCs_ManhattanPlot,path = file.path(outputFolder,"2.ManhattanPlots/"), device='png', dpi=300, width = 10, height = 7)
```
# BDS vs. HC QQplot
### NO SVA
```{r}
...
ggsave(filename = BDSvsHCQQplot,path = file.path(outputFolder,"1.QQplots/"), device='png', dpi=300, width = 7, height = 7)
...
qq + ggtitle("BDS vs. HC QQPlot - svaPCs") +
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U")) + 
  annotate("text", x = Inf, y = Inf, label = paste("lambda GC =", round(lambda_gc, 3)), 
           hjust = 1.1, vjust = 1.1, size = 5, color = "red")
ggsave(filename = BDSvsHCQQplot_svaPCs,path = file.path(outputFolder,"1.QQplots/"), device='png', dpi=300, width = 7, height = 7)
```
...
#   labSize = 2.0,)
# 
# BDSvsHC_EnhVolc + ggtitle("BDS vs. HC Enhanced Volcano Nominal p-value",
#                          subtitle = "") +
#   theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
# #ggsave(paste0("VolcanoPlot_BD_v_HC_Nominal-p",date,".png"),path = "V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/2.Output_EWAS-models/3.VolcanoPlots", device='png', dpi=300, width = 10, height = 7)
# ggsave(paste0("EWAS-BB-BDSvsHC_Nominal-pVolcanoPlot",date,".png"),path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
################################################################################
...
BDSvsHC_EnhVolc =EnhancedVolcano(DMPs_volcano,
  ...
  xlim = c(-1.8,1.8),
  labSize = 2.0)
BDSvsHC_EnhVolc + ggtitle("BDS vs. HC Enhanced Volcano FDR-Corrected p-value", 
                         subtitle = "") +
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
#ggsave(paste0("VolcanoPlot_BD_v_HC_FDR-corrected",date,".png"),path = "V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/2.Output_EWAS-models/3.VolcanoPlots", device='png', dpi=300, width = 10, height = 7)
ggsave(filename = BDSvsHC_FDR_CorrectedVolcanoPlot,path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
...
BDSvsHC_ggplot = ggplot(data=DMPs_sorted, aes(x=logFC, y=-log10(P.Value))) +
...
BDSvsHC_ggplot + ggtitle("BDS vs. HC - Volcano Plot", 
                         subtitle = "") +
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
ggsave(filename = BDSvsHC_FDR_Corrected_VolcanoPlot,path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
```
...
# library(EnhancedVolcano)
# BDSvsHC_EnhVolc =EnhancedVolcano(DMPsSVA_volcano,
#   lab = NA,
#   x = 'log2FoldChange',
#   y = 'pvalue',
#   pCutoff = pv,
...
#   theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
# #ggsave(paste0("VolcanoPlot_BD_v_HC_FDR-corrected",date,".png"),path = "V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/2.Output_EWAS-models/3.VolcanoPlots", device='png', dpi=300, width = 10, height = 7)
# ggsave(paste0("EWAS-BB-BDSvsHC_NominalP-val_svaPCsVolcanoPlot",date,".png"),path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
# 
# ################################################################################
# # FDRcorrected p-value 
# ################################################################################
...
BDSvsHC_EnhVolc + ggtitle("BDS vs. HC Enhanced Volcano FDR-Corrected p-value", 
  ...
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
#ggsave(paste0("VolcanoPlot_BD_v_HC_FDR-corrected",date,".png"),path = "V:/common/Walss-Bass_Lab/Walss-Bass lab juliet/Iago/1.EWAS_K01_Analysis/Aug.24-EWAS_BDSvsHC_BRAINBANK/2.Output_EWAS-models/3.VolcanoPlots", device='png', dpi=300, width = 10, height = 7)
ggsave(filename = BDSvsHC_FDR_Corrected_svaPCsVolcanoPlot,path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
...
# load library
# plot adding up all layers we have seen so far
BDSvsHC_ggplot = ggplot(data=DMPsSVA_sorted, aes(x=logFC, y=-log10(P.Value))) +
        geom_point(aes(color=ifelse(-log10(P.Value) > -log10(9e-8), "above", "below")), show.legend = FALSE) + 
...
BDSvsHC_ggplot + ggtitle("BDS vs. HC - Volcano Plot", 
  ...
  theme(plot.title = element_text(size = 15, face = "bold", family = "Segoi U"))
ggsave(filename = BDSvsHC_FDR_Corrected_svaPCs_VolcanoPlot,path = file.path(outputFolder,"3.VolcanoPlots"), device='png', dpi=300, width = 10, height = 7)
```
